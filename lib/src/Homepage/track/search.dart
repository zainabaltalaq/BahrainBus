...
class _MapViewState extends State<MapView> {
  final CameraPosition _initialLocation =
      const CameraPosition(target: LatLng(26.0667, 50.5577));
  ...
  _createPolylines(
    ...
    PolylineResult result = await polylinePoints.getRouteBetweenCoordinates(
      'AIzaSyD6icpc6_SIelb5ZPkyC_eNLBTIlNG-Cks', // Google Maps API Key
                ...
                children: <Widget>[
                  ClipOval(
                    child: Material(
                      ...
                      child: InkWell(
                        splashColor:
                            Color.fromARGB(255, 114, 26, 26), // inkwell color
